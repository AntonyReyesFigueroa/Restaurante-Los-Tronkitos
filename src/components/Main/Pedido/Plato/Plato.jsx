...
const Plato = ({ data, setInfoPedido, infoPedido, setEstadoBtnPedido, estadoBtnPedido, recuperDataPlato, estadoEnvioElimar, setEstadoEnvioElimar,
    booleanCaptarDeDetalle, setbooleanCaptarDeDetalle,setRecuperDataPlato
}) => {
