...
const Bebida = ({ data, setInfoPedido, infoPedido, setEstadoBtnPedido, estadoBtnPedido, recuperDataPlato,setRecuperDataPlato, estadoEnvioElimar, setEstadoEnvioElimar,
